...
👉 [Bam vao day de tai IPA](https://raw.githubusercontent.com/nguyenthao158258-web/HIDProbe-USB-Local/main/dist/HIDProbeApp_DOPAMINE_PREBOOT_JBROOT_20260710204500.ipa)

Ten file: `HIDProbeApp_DOPAMINE_PREBOOT_JBROOT_20260710204500.ipa`

SHA256 IPA: `5e5eb3eb42dbc9088ab2b12fcd2b172c1436d1c0fc66683d8002ceb927e0cd2a`
...
- Khi `/var/jb` chua ton tai, root helper tim JBROOT Dopamine that trong `/private/preboot/<hash>/dopamine-*/procursus`, sau do stage plist vao `Library/LaunchDaemons` cua JBROOT do.
...
- Build moi da bump `CFBundleVersion=20260710204500`, tranh tinh trang cai IPA moi nhung iOS/TrollStore van nhin nhu ban cu.
- Daemon version: `hidprobe_daemon/1.3.11-preboot-jbroot`.
