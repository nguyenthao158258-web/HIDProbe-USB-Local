...
👉 [Bam vao day de tai IPA](https://raw.githubusercontent.com/nguyenthao158258-web/HIDProbe-USB-Local/main/dist/HIDProbeApp_DOPAMINE_AUTO_RECOVERY_20260710185034.ipa)

Ten file: `HIDProbeApp_DOPAMINE_AUTO_RECOVERY_20260710185034.ipa`

SHA256 IPA: `7d00060a35b6fb1b48a242056a16e76022ddc43d4a4bedba14adfc1dab4df9a7`
...
- Ban Dopamine recovery nhan FilzaHelper dang chay qua XPC de copy plist vao `/var/jb/Library/LaunchDaemons` va dat owner root. Muc dich la de Dopamine launchd hook mo watchdog va HID ngay sau khi Dopamine duoc kich hoat.
...
- Build moi da bump `CFBundleVersion=20260710185034`, tranh tinh trang cai IPA moi nhung iOS/TrollStore van nhin nhu ban cu.
- Daemon version: `hidprobe_daemon/1.3.7-filza-stage`.
...
2. Mo HID Probe it nhat 1 lan de app copy/lap lai daemon.
   ...
   - Kiem tra upgrade log co `filza_rootless_stage success=true` truoc khi reboot.
